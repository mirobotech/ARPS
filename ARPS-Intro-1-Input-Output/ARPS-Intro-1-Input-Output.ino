...
1.  Let's analyze this program! Program analysis is an important skill to
    ...
    your ARPS circuit on top of your Arduino, and then connect the Arduino
    ...
    Press and release pushbutton SW2 on your ARPS circuit while observing
    its LEDs.
...
2.  The first line of code in the program's main 'loop()' function is:
  ...
  if(SW2State == LOW) {
    ...
    to on the Arduino UNO used with your ARPS?
...
3.  Arduino has a built-in tone() function that can be used to make a specified
  ...
  if(SW5State == LOW) {
    ...
    The tone can be silenced by pressing the RESET button (SW1) on ARPS, or
...
9.  Imagine that you would like to apply your newly-acquired microcontroller
    ...
    write a program that uses the LEDs and pushbuttons on ARPS to simulate
    their operation.
